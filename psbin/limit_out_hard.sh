...
slowDevice(){
	...
	# filter by ip
	tc filter add dev $1 parent 1:0 protocol ip u32 match ip dst 10.1.1.10/32 flowid 1:3
        tc filter add dev $1 parent 1:0 protocol ip u32 match ip src 10.1.1.10/32 flowid 1:3
	tc filter add dev $1 parent 1:0 protocol ip u32 match ip dst 10.1.1.11/32 flowid 1:3
        tc filter add dev $1 parent 1:0 protocol ip u32 match ip src 10.1.1.11/32 flowid 1:3
    # done
}
# ===============================================================================================================
# MAIN
