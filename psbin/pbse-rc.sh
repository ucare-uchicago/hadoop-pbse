...
export HADOOP_PREFIX=${DIR}/hadoop-2.7.1
export HADOOP_CONF_DIR=${DIR}/hadoop-ucare/psbin/ucare_se_conf/hadoop-etc/hadoop-2.7.1
export HADOOP_HOME=${HADOOP_PREFIX}
export HADOOP_LOG_DIR=/tmp/hadoop-ucare/logs/hadoop
export YARN_LOG_DIR=/tmp/hadoop-ucare/logs/yarn

export PSBIN=${DIR}/hadoop-ucare/psbin
