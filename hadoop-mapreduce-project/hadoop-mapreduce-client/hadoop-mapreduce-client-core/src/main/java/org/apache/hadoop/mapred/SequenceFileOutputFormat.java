...
public class SequenceFileOutputFormat <K,V> extends FileOutputFormat<K, V> {
  ...
  private class AnonymousRecordWriter implements RecordWriter<K, V>,
      OutputStreamOwner {

    private SequenceFile.Writer out;

    public AnonymousRecordWriter(SequenceFile.Writer out) {
      this.out = out;
    }
  ...
  public RecordWriter<K, V> getRecordWriter(
    ...
    // riza: return class implementing RecordWriter & OutputStreamOwner
...
//      };
    return new AnonymousRecordWriter(out);
  }
